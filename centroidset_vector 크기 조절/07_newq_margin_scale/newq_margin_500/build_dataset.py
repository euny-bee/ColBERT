...
# q0("...house reshingled")의 500-distractor pool 내 top-100 경쟁 passage 중 top-50만 강제 포함
import json as _json
with open(r'C:\Users\nmdl-khb\ColBERT\centroidset_vector 크기 조절\06_newq_margin\q0_top100_competitors.json') as _f:
    Q0_TOP100 = _json.load(_f)
Q0_COMPETITOR_PIDS = Q0_TOP100[:50]
print(f"q0 top-50 경쟁 passage {len(Q0_COMPETITOR_PIDS)}개 강제 포함")
...
# ==========================================================================
print("\n[Step 2] Distractor 샘플링 중 (q0 top-50 경쟁 passage 강제 포함)...")
required = TRUE_PIDS + Q0_COMPETITOR_PIDS
random.seed(SEED)
...
print(f"  pool 크기: {len(pool_pids)}  (true={len(TRUE_PIDS)}, q0 top50={len(Q0_COMPETITOR_PIDS)}, random distractor={len(distractors)})")
