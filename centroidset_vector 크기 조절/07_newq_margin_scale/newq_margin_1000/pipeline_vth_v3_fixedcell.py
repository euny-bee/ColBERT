...
[clip99.9] ColBERT 아날로그 파이프라인 — Vth mismatch v3 모델, "셀단위 고정 Vth" 버전 (1+2 조합)
  newq_margin 폴더 전용: margin(1등 true vs 2등 경쟁 문서) 기준으로 뽑은 3-query
...
doc  = pd.read_excel(f'{BASE}/[clip99.9]doc_embs_65859x128.xlsx', index_col=0)
...
print("\nPipeline (newq_margin fixedcell) 완료!")
