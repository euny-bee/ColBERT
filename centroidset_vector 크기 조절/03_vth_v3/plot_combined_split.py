"""
[vth_v3]combined_2x3.png 의 두 줄을 각각 별도 파일로 저장.
  [vth_v3]row0_scatter.png  — Row 0: Digital L2 vs Option A/C rank scatter
  [vth_v3]row1_bar.png      — Row 1: Candidate set stacked bar
"""
...
for panel_idx, q_id in enumerate([1, 0]):
    ...
    if panel_idx == 0:
        ax.legend(handles=[
           ...
           title='Ranking Comparison', title_fontsize=16)

fig0.tight_layout()
out0 = f'{BASE}/[vth_v3]row0_scatter.png'
...
fig1.tight_layout()
out1 = f'{BASE}/[vth_v3]row1_bar.png'
