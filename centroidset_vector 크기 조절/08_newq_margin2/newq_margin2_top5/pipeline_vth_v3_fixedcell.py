...
[clip99.9] ColBERT 아날로그 파이프라인 — Vth mismatch v3 모델, "셀단위 고정 Vth" 버전 (1+2 조합)
  newq_margin2_top5 폴더 전용: margin 타이트(1.76~2.01)한 신규 3-query, 경쟁자 top-1(rank2)만 강제 포함
...
DOC_XLSX       = f'{BASE}/[clip99.9]doc_embs_13388x128.xlsx'
NPROBE         = 2
...
print("\nPipeline (newq_margin2_top5 fixedcell) 완료!")
