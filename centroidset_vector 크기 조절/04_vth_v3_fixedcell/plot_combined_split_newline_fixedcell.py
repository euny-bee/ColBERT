"""
plot_combined_split_newline.py 의 fixedcell 버전.
  [vth_v3_fixedcell]step2/step3/step6_*.xlsx (셀단위 고정 Vth, 1+2 조합)를 읽어
  [vth_v3_fixedcell]row0_scatter_newline.png  — Row 0: Digital L2 vs Option A/C rank scatter
  [vth_v3_fixedcell]row1_bar.png              — Row 1: Candidate set stacked bar
  기존 [vth_v3] 파일/figure는 건드리지 않음.
"""
