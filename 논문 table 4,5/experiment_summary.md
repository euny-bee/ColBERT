...
*잔차에 가우시안 노이즈 N(0, σ)를 추가하여 아날로그 소자의 노이즈 영향을 시뮬레이션.*

| σ (noise level) | MRR@10 | R@50 | R@1k | MRR@10 변화 |
|-----------------|--------|------|------|-------------|
| 0 (노이즈 없음) | 0.8236 | 0.9854 | 0.9972 | 기준 |
| 0.01 | 0.6562 | 0.9478 | 0.9972 | -0.1674 |
| 0.05 | 0.5424 | 0.9072 | 0.9972 | -0.2812 |
| 0.1 | 0.3945 | 0.8208 | 0.9972 | -0.4291 |
| 0.2 | 0.1792 | 0.6038 | 0.9972 | -0.6444 |
