"""
plot_seed19_q2_r2.py의 색상 변형본 -- Vth comp 파랑을 #2196F3 -> #1565C0(TOPSW "this work" 파랑)로 교체.
...
C3 = {'optA': '#1565C0', 'optC': '#FF7811', 'true': '#E91E63'}   # optA: #2196F3 -> #1565C0
...
fig.tight_layout()
out = f'{OUT_BASE}/[newq_margin_seed19]q2_scatter_r2_1565C0.png'
...
fig_r2.tight_layout()
r2_out = f'{OUT_BASE}/[newq_margin_seed19]q2_scatter_r2_textbox_1565C0.png'
...
leg_out = f'{OUT_BASE}/[newq_margin_seed19]q2_scatter_r2_legend_1565C0.png'
...
leg_out2 = f'{OUT_BASE}/[newq_margin_seed19]q2_scatter_r2_legend_vertical_boxed_1565C0.png'
