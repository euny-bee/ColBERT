"""
plot_seed19.py의 확대(zoom) 버전 -- 기존 파일은 그대로 두고 새 파일로 저장.
3개 패널 모두 x/y축을 0~100으로 고정해서 근접 구간을 확대해서 봄.
"""
import matplotlib
matplotlib.use('Agg')
import pandas as pd
...
print("Row 0 (scatter, zoom 0~100) 그리는 중...")
...
fig0.tight_layout()
out0 = f'{OUT_BASE}/[newq_margin_seed19]row0_scatter_newline_zoom100.png'
