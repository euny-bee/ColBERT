...
Output: table_optC_rankonly_v2.png
"""
...
OUTPUT     = SCRIPT_DIR / "table_optC_rankonly_v2.png"
...
# ── Table content ─────────────────────────────────────────────────────────────
rows_baseline = [
    ("Digital (no quantization)",  "--", "78.4", "83.1", "98.8",  "99.6"),
    ("Digital (2bit quantization)","--", "76.9", "81.9", "98.8", "100.0"),
