...
Output: table_periphery_full_with_write_fig5_scope.png
"""
...
OUTPUT     = SCRIPT_DIR / "table_periphery_full_with_write_fig5_scope.png"
...
TITLE = "System-level scale used in Figs. 5a–5c (2,048 centroids + 255 queries + 10,988 documents)"
...
rows = [
    ...
    ("+ Driver",             "+189,561.60 nJ", "shared",        "221,522.53 nJ", "0.4821 TOPS/W", "17.8×"),
    ("+ ML buffer (final)",  "+87,601.92 nJ",  "shared",        "309,124.45 nJ", "0.3454 TOPS/W", "12.8×"),
]

COL_X   = [0.02]
COL_NUM = [0.295, 0.445, 0.595, 0.73, 0.855]
...
ax.text(0.0, y_bottom - 0.028,
        ...
        "(cell -> +TIA -> +ADC -> +driver -> +ML buffer, Option A) plus shared one-time write-phase energy (index build:\n"
        "cell + row/col write-driver, Option A) amortized over an assumed index lifetime of 255 queries.\n"
        "Write total: 3,133,780.0 nJ (2,048 centroids, 10,988 documents). Search entries are component increments from\n"
        "periphery_energy_model_v2.py; total energy is cumulative. Search and write include their own row/col driver, so vs.-GPU\n"
